...
user12 = User.create(
  ...
  address: "Venezuela 136, San Telmo, Buenos Aires",
...
user13 = User.create(
  ...
  address: "Sauces 132, Recoleta, Buenos Aires",
...
user15 = User.create(
  ...
  address: "Robles 138, Recoleta, Buenos Aires",
...
user16 = User.create(
  ...
  address: "Arévalo 738, Palermo, Buenos Aires",
...
user17 = User.create(
  ...
  address: "Niceto Vega 450, Palermo, Buenos Aires",
...
# user18 = User.create(
#   email: "fantasia@express.com",
#   password: "123456",
#   name: "fredy",
#   user_name: "fredy55",
#   supplier: true,
#   business_name: "Fantasía Express",
#   address: "La Plata 96, Almagro, Buenos Aires",
#   description: "Fantasía Express es una empresa especializada en el alquiler y venta de disfraces para todo tipo de eventos y celebraciones. Nos apasiona hacer realidad las fantasías de nuestros clientes y proporcionarles una experiencia única al transformarse en personajes de sus películas, series o épocas favoritas. Con una amplia selección de disfraces de alta calidad, nos esforzamos por brindar un servicio excepcional y ayudar a nuestros clientes a crear recuerdos inolvidables.",
#   service_type: "Disfraces & Accesorios",
#   duration: "Los disfraces se pueden alquilar por días o semanas, según las necesidades de los clientes.",
#   includes: "Amplia variedad de disfraces temáticos, tallas para niños y adultos, accesorios complementarios, asesoramiento personalizado para la elección de disfraces.",
#   benefits: "Calidad y variedad de disfraces, limpieza y mantenimiento rigurosos, precios competitivos, atención al cliente amigable y profesional, experiencia en ayudar a los clientes a encontrar el disfraz perfecto."
# )

# cumpleanos_adultos18 = EventType.new(name: "Cumpleaños Adultos")
# cumpleanos_adultos18.user_id = user18.id
# cumpleanos_adultos18.save!

# empresariales18 = EventType.new(name: "Empresariales")
# empresariales18.user_id = user18.id
# empresariales18.save!

# baby18 = EventType.new(name: "Baby Showers")
# baby18.user_id = user17.id
# baby18.save!

# quince18 = EventType.new(name: "15 Años")
# quince18.user_id = user18.id
# quince18.save!

# despedidas18 = EventType.new(name: "Despedidas")
# despedidas18.user_id = user18.id
# despedidas18.save!

# casamientos18 = EventType.new(name: "Casamientos")
# casamientos18.user_id = user18.id
# casamientos18.save!

# bautismos18 = EventType.new(name: "Bautismos")
# bautismos18.user_id = user18.id
# bautismos18.save!

# file = URI.open("https://atelierdellalbergo.it/wp-content/uploads/2021/12/finger-food-plastica.jpg")
# user18.photos.attach(io: file, filename: "finger-food-plastica.jpg", content_type: "image/jpg")

# file = URI.open("https://img.freepik.com/fotos-premium/apetitosos-aperitivos-mesa-buffet-evento-cerca_120897-1064.jpg")
# user18.photos.attach(io: file, filename: "apetitosos-aperitivos-mesa-buffet-evento-cerca_120897-1064.jpg", content_type: "image/jpg")

# file = URI.open("https://t3.ftcdn.net/jpg/02/71/96/34/360_F_271963483_tJYIqsd4RvUgODqV3IbX3EmTF7hU6b4p.jpg")
# user18.photos.attach(io: file, filename: "360_F_271963483_tJYIqsd4RvUgODqV3IbX3EmTF7hU6b4p.jpg", content_type: "image/jpg")

# file = URI.open("https://img.freepik.com/foto-gratis/comida-canapes_624325-2035.jpg")
# user18.photos.attach(io: file, filename: "comida-canapes_624325-2035.jpg", content_type: "image/jpg")
