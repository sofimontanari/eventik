...
ActiveRecord::Schema[7.0].define(version: 2023_06_19_202212) do
  ...
  create_table "chatrooms", force: :cascade do |t|
    ...
    t.index ["estimation_id"], name: "index_chatrooms_on_estimation_id"
  end
  ...
  add_foreign_key "chatrooms", "estimations"
